...
public class MymenshinghDistrict extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title = getResources().getStringArray(R.array.MymonshinghDistrict);
        subTitle = getResources().getStringArray(R.array.MymonshinghDistrict_subTitle);
