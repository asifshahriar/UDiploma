...
public class BarishalDistrict extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title = getResources().getStringArray(R.array.BarishalDistrict);
        subTitle = getResources().getStringArray(R.array.BarishalDistrict_subTitle);
